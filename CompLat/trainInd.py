...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for data in train_loader:  # Iterate over your training dataset
            ...
            # zs=vae(inputs)
            zoutputs = rnn(acts.transpose(1, 0).to(device),obs_z.view(batchsize, 15, 64).transpose(1, 0))
            # Forward pass
        ...
        }, is_best, 'action-best.tar', 'action-checkpoint.tar')
        ...
        for data in test_loader:  # Iterate over your training dataset
            ...
            for savei in range(199):
                out = rnn(test_img.view(15, 1, 64), torch.zeros((15, 1, 3)).to(device))
            ...
            save_image(saved_pred.view(215, 1, 64, 64),
                       'lat_pred_action/origin_' + str(epoch) + '.png')
